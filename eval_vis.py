...
def main(args):
    ...
    # data_file = 'data/vibe_db/ssp3d_val_db.pt'

    image_folder = 'data/ssp_3d/images'
    output_path = 'output/sample_images'
    ...
    print(f'Performance of pretrained model: {ckpt["performance"]}')
